...
function solicitarProcesso($token)
{
    try {
        ...
        $dados = [
            ...
            "webhookUrl" => "https://webhook.site/e41af82e-ba7a-4523-83d6-f7047df70720"
        ];
...
// consultarResultado($token, "4913");
// consultarDocumento($token, "f411eb61-5e2f-4f89-86ba-d6bfdc79475b");
